...
final class AspectTest extends TestCase
{
    public function testAttributeConstruction(): void
    {
        ...
        // Aspect is a marker attribute that extends AutoconfigureTag
        $this->assertNotNull($attribute->tags);
        $this->assertSame([[Aspect::TAG_NAME => []]], $attribute->tags);
    }
    ...
    public function testAutoconfigureTag(): void
    {
        ...
        $this->assertNotNull($aspect->tags);
        $this->assertSame([[Aspect::TAG_NAME => []]], $aspect->tags);
    }
}
